...
export function Activity({ data }: Props) {
  return (
    <View
      className={clsx('w-full bg-zinc-900 px-4 py-3 rounded-lg flex-row items-center border border-zinc-800 gap-3', {
    ...
    >
      ...
      <Text className="text-zinc-100 font-regular text-base flex-1">{data.title}</Text>

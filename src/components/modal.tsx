...
import { ModalProps, Modal as RNModal, ScrollView, Text, TouchableOpacity, View } from 'react-native';
          ...
          <View className="bg-zinc-900 border-t border-zinc-700 px-6 pt-5 pb-10">
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              {subtitle.trim().length > 0 && (
                <Text className="text-zinc-400 font-regular leading-6  my-2">{subtitle}</Text>
              )}
